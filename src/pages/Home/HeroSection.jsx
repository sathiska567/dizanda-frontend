    ...
    <section className="relative overflow-hidden bg-luxury-sand">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-24">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] items-center">
          ...
          >
            <p className="text-xs uppercase tracking-extreme text-luxury-charcoal/70 mb-4">{hero.eyebrow}</p>
          ...
          >
            <p className="text-[10px] uppercase tracking-extreme text-luxury-muted mb-3">{hero.cardEyebrow}</p>
